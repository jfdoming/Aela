...
//
//Game::OldCharacterTracker::OldCharacterTracker() {
...
//}
//
//void Game::OldCharacterTracker::setup() {
//	scriptManager = GameObjectProvider::getScriptManager();
//}
//
//void Game::OldCharacterTracker::update() {
//	for (auto pair : characters) {
...
//}
//
//void Game::OldCharacterTracker::scenesWereSetUp() {
//	gameplayScene = GameObjectProvider::getGameplayScene();
//}
//
//void Game::OldCharacterTracker::generateCharacterModels(ResourceManager* resourceManager) {
...
//}
//
//bool Game::OldCharacterTracker::trackCharacter(Character* character, size_t* id) {
...
//}
//
//bool Game::OldCharacterTracker::deleteCharacterByID(size_t id) {
...
//}
//
//Game::Character* Game::OldCharacterTracker::getCharacterByID(size_t id) {
...
//}
//
//Game::Character* Game::OldCharacterTracker::getCharacterByName(std::string name) {
...
//}
//
//Game::Character* Game::OldCharacterTracker::getCharacterByLocation(Location* location) {
...
//	Game::OldCharacterTracker::getCharactersInChunk(size_t world, glm::ivec2 chunk) {
...
//}
//
//void Game::OldCharacterTracker::turnTrackedCharacter(Character* character, TileDirection direction) {
...
//}
//
//void Game::OldCharacterTracker::turnTrackedCharacter(size_t id, TileDirection direction) {
...
//}
//
//void Game::OldCharacterTracker::turnTrackedCharacter(std::string name, TileDirection direction) {
//	auto iter = charactersByName.find(name);
//	if (iter == charactersByName.end()) {
//		return;
//	}
...
//}
//
//void Game::OldCharacterTracker::moveTrackedCharacter(Character* character, Movement* movement, std::string scriptOnCompletion) {
//	character->move(movement, scriptOnCompletion);
//	turnTrackedCharacter(character, movement->getDirection());
//}
//
//void Game::OldCharacterTracker::moveTrackedCharacter(size_t id, Movement* movement, std::string scriptOnCompletion) {
//	Character* character = getCharacterByID(id);
//	if (character == nullptr) {
//		return;
//	}
...
//}
//
//void Game::OldCharacterTracker::moveTrackedCharacter(std::string name, Movement* movement, std::string scriptOnCompletion) {
//	auto iter = charactersByName.find(name);
//	if (iter == charactersByName.end()) {
//		return;
//	}
...
//}
//
//void Game::OldCharacterTracker::teleportTrackedCharacter(Character* character, Location* location, bool animation) {
...
//}
//
//void Game::OldCharacterTracker::teleportTrackedCharacter(size_t id, Location* location, bool animation) {
//	Character* character = getCharacterByID(id);
//	if (character == nullptr) {
//		return;
//	}
...
//}
//
//void Game::OldCharacterTracker::teleportTrackedCharacter(std::string name, Location* location, bool animation) {
//	auto iter = charactersByName.find(name);
//	if (iter == charactersByName.end()) {
//		return;
//	}
...
//}
//
//bool Game::OldCharacterTracker::doesMapNeedToBeRebuilt() {
//	return mapNeedsToBeRebuilt;
//}
//
//void Game::OldCharacterTracker::mapWasRebuilt() {
//	mapNeedsToBeRebuilt = false;
//}
//
//void Game::OldCharacterTracker::setPlayer(size_t id) {
//	playerID = id;
//}
//
//bool Game::OldCharacterTracker::isPlayerDead() {
//	return playerIsDead;
//}
//
//void Game::OldCharacterTracker::setGameplayMenuItems(std::shared_ptr<RectComponent> deathRect, std::shared_ptr<Label> deathText) {
//	this->deathRect = deathRect;
//	this->deathText = deathText;
//}
//
//void Game::OldCharacterTracker::processCharacterMovement(Character* character, Movement* movement, std::string scriptOnCompletion) {
...
//}
//
//void Game::OldCharacterTracker::animateCamera(glm::vec3 translation, float speed, long long timeToAdvanceTrackBy) {
...
//}
//
//void Game::OldCharacterTracker::animateCharacterDeath(Character* character) {
...
//}
//
//void Game::OldCharacterTracker::animatePlayerDeathScreen() {
...
//}
//
//void Game::OldCharacterTracker::resetCameraPosition() {
