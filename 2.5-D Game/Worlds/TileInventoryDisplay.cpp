...
void Game::TileInventoryDisplay::refreshSubMenu() {
	...
	//std::cout << player->getTileInventory()->getCurrentTile()->getType() << " A\n";
	//std::cout << "B: ";
	//std::cout << worldManager->getTileAtlas()->getTileType(player->getTileInventory()->getCurrentTile()->getType());
	//std::cout << "\n C: " << worldManager->getTileAtlas()->getTileType(player->getTileInventory()->getCurrentTile()->getType())->getName() << "\n";
