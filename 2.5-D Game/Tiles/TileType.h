...
namespace Game {
	enum class TileShape {
		...
		WALL_CORNER_DOWN_RIGHT, QUARTER_WALL_UP_RIGHT, QUARTER_WALL_UP_LEFT, QUARTER_WALL_DOWN_LEFT, QUARTER_WALL_DOWN_RIGHT,
		GLASS_RIGHT, GLASS_FRONT, GLASS_LEFT, GLASS_FLOOR, LIQUID_BOX, TELEPORTER, DOOR_1, DOOR_2, DOOR_3, DOOR_4, CEILING,
		TELECOM, HALF_FLOOR
	};
