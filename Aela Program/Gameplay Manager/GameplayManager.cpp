...
void GameplayManager::update() {
	// Note: this fuction will eventually be split into some smaller functions in order to avoid chaos. I have't done so yet
	// since most of this code is just temporary and is here to test physics.
