...
//
//	// Get a handle for our "myTextureSampler" uniform
//	GLuint particleTextureID = glGetUniformLocation(programID, "myTextureSampler");
//
//
...
//
//		// Bind our particleTexture in Texture Unit 0
//		glActiveTexture(GL_TEXTURE1);
//		glBindTexture(GL_TEXTURE_2D, particleTexture);
//		// Set our "myTextureSampler" sampler to user Texture Unit 1
//		glUniform1i(particleTextureID, 1);
//
...
//
//
//		// 4th attribute buffer : positions of particles' centers
...
//		);
//
//		// 5th attribute buffer : particles' colors
