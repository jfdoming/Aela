...
void Aela::AnimationLooper::stopLooping3DTrack(std::string tag) {
...
void Aela::AnimationLooper::stopLooping2DTrack(std::string tag) {
...
void Aela::AnimationLooper::stopLoopingMaterialTrack(std::string tag) {
...
void Aela::AnimationLooper::stopLoopingModelTrack(std::string tag) {
...
void Aela::AnimationLooper::stopLoopingTrack(std::string tag) {
