...
int startAela() {
	...
	std::cout << "Before renderer3D\n" << &window;
	Aela3DRenderer renderer3D(&window);
	std::cout << "After renderer3D";
	...
	do {
		...
		for (int whichModel = 0; whichModel < models.size(); whichModel++) {
			...
			glBufferData(GL_ARRAY_BUFFER, models[whichModel].getVertexSize() * sizeof(glm::vec3), models[whichModel].getVertices(), GL_STATIC_DRAW);
			// std::cout << models[whichModel].getVertices().size()

			GLuint uvbuffer;
			glGenBuffers(1, &uvbuffer);
			glBindBuffer(GL_ARRAY_BUFFER, uvbuffer);
			glBufferData(GL_ARRAY_BUFFER, models[whichModel].getUVSize() * sizeof(glm::vec2), models[whichModel].getUVs(), GL_STATIC_DRAW);

			GLuint normalbuffer;
			glGenBuffers(1, &normalbuffer);
			glBindBuffer(GL_ARRAY_BUFFER, normalbuffer);
			glBufferData(GL_ARRAY_BUFFER, models[whichModel].getNormalSize() * sizeof(glm::vec3), models[whichModel].getNormals(), GL_STATIC_DRAW);

			GLuint elementbuffer;
			glGenBuffers(1, &elementbuffer);
			glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, elementbuffer);
			glBufferData(GL_ELEMENT_ARRAY_BUFFER, models[whichModel].getIndexSize() * sizeof(unsigned short), models[whichModel].getIndices(), GL_STATIC_DRAW);
			...
			glDrawElements(
				GL_TRIANGLES,      // mode
				models[whichModel].getIndexSize(),    // count
		...
		for (int whichModel = 0; whichModel < models.size(); whichModel++) {
			...
			glBindTexture(GL_TEXTURE_2D, *models[whichModel].getTexture());
